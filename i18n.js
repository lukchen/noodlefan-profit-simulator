...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "am.hint": "Extras that attach to an order — they add revenue & food cost but are NOT counted as separate orders (no packaging / order fee). Drinks work the same way.",
    ...
    zh: {
      ...
      "dr.addDrink": "+ 添加饮料",
      "am.title": "配菜加料",
      "am.hint": "挂在订单上的加料 — 计营收和食材成本，但不算独立订单（不加包装 / 订单费）。饮料同理。",
      "am.addAddon": "+ 添加加料",
      "sm.col.dish": "菜品",
      "sm.col.price": "售价 ($)",
      "sm.col.cost": "成本 ($)",
