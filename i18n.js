...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "sm.hint": "Set the direct + per-platform prices, ingredient cost, and expected daily orders for each dish.",
      "dr.title": "Sides & Drinks 小菜和饮料",
      "dr.addDrink": "+ Add side / drink",
      "am.title": "Add-ons 配菜加料",
      "am.hint": "Extras that attach to an order — they add revenue & food cost but are NOT counted as separate orders (no packaging / order fee). Sides & drinks work the same way.",
      "am.addAddon": "+ Add add-on",
      "sm.col.dish": "Dish",
      "sm.col.price": "Direct ($)",
      "sm.col.pFantuan": "Fantuan ($)",
      "sm.col.pUber": "Uber ($)",
      "sm.col.pDoorDash": "DoorDash ($)",
      "sm.col.pGrubhub": "Grubhub ($)",
      "sm.col.cost": "Cost ($)",
      "sm.col.qty": "Orders/Day",
      "sm.dish1": "Tianjin Yellow Broth Beef Noodle 天津黄汤牛肉拉面",
      "sm.dish2": "Taiwanese Beef Noodle 台式牛肉面",
      "sm.dish3": "Authentic Jiangxi Fried Rice Noodle 地道江西炒粉",
      "sm.dish4": "Signature Jiangxi Garden Mushroom Rice Noodle Soup 招牌江西三鲜泡粉",
      "sm.dish5": "Signature Jiangxi Spicy Beef Rice Noodle Soup 招牌江西牛肉泡粉",
      "sm.blended": "Blended",
      "sm.aovLabel": "AOV:",
    ...
    zh: {
      ...
      "sm.title": "主菜品",
      "sm.hint": "设置每道菜的 直营 + 各平台售价、食材成本及预计每日销售数量。",
      "dr.title": "小菜和饮料",
      "dr.addDrink": "+ 添加小菜/饮料",
      "am.title": "配菜加料",
      "am.hint": "挂在订单上的加料 — 计营收和食材成本，但不算独立订单（不加包装 / 订单费）。小菜和饮料同理。",
      "am.addAddon": "+ 添加加料",
      "sm.col.dish": "菜品",
      "sm.col.price": "直营 ($)",
      "sm.col.pFantuan": "饭团 ($)",
