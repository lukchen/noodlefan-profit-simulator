...
const DEFAULTS = {};
const STORAGE_KEY = "noodlefan-profit-sim-v29";
...
const DEFAULT_MAINS = [
  ...
  { name: "招牌江西三鲜泡粉 Jiangxi Garden Mushroom Rice Noodle Soup",     price: 9.99,  pG: 10.99, pU: 11.99, pD: 12.99, pGH: 12.99, cost: 1.40, qty: 8 },
  { name: "招牌江西牛肉泡粉 Jiangxi Spicy Beef Rice Noodle Soup",     price: 16.99, pG: 17.99, pU: 18.99, pD: 19.99, pGH: 19.99, cost: 3.73, qty: 10 },
